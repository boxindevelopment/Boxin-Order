...
class OrderDetailRepository implements OrderDetailRepositoryInterface
{
    ...
    public function findPaginateMyBox($args = [])
    {
        ...
        $query->select('order_details.id', 'order_details.order_id', 'order_details.is_returned', 'order_details.types_of_duration_id', 'order_details.room_or_box_id', 'order_details.types_of_box_room_id', 'order_details.types_of_size_id', 'order_details.name', 'order_details.duration', 'order_details.amount', 'order_details.start_date', 'order_details.end_date', DB::raw('order_details.status_id AS status_order_detail'), DB::raw('orders.status_id as status_id'), DB::raw('orders.user_id as user_id'), 
            DB::raw('datediff("Day", order_details.end_date, order_details.start_date) as total_time'), 
            DB::raw('datediff("Day", GETDATE(),order_details.start_date) as selisih'));
